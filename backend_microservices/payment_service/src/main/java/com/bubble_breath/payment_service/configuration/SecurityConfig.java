    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/Payment/**", "/api/Payment",
                                                        "").permitAll()
                        // POST, PUT, DELETE - require JWT
                        .requestMatchers(HttpMethod.POST, "/api/Payment", "").authenticated()
                        .requestMatchers(HttpMethod.PUT, "/api/Payment", "").authenticated()
                        .requestMatchers(HttpMethod.DELETE, "/api/Payment/**", "/api/Category/**").authenticated()
