    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/Reward/**", "/api/Reward",
                                                        "").permitAll()
                        // POST, PUT, DELETE - require JWT
                        .requestMatchers(HttpMethod.POST, "/api/Reward", "").authenticated()
                        .requestMatchers(HttpMethod.PUT, "/api/Reward", "").authenticated()
                        .requestMatchers(HttpMethod.DELETE, "/api/Reward/**", "/api/Category/**").authenticated()
