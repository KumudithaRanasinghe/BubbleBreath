    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/Reward/**", "/Reward").permitAll()
                        // POST, PUT, DELETE - require JWT
                        .requestMatchers(HttpMethod.POST, "/Reward").authenticated()
                        .requestMatchers(HttpMethod.PUT, "/Reward").authenticated()
                        .requestMatchers(HttpMethod.DELETE, "/Reward/**").authenticated()
